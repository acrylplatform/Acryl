...
import com.acrylplatform.lang.v1.traits.DataType
...
import com.acrylplatform.transaction.{Authorized, CreateAliasTransactionV1, DataTransaction, Transaction}
...
object ExtractInfo extends App with ScorexLogging {
  ...
  try {
    val state = new LevelDBWriter(db, Observer.empty(UncaughtExceptionReporter.LogExceptionsToStandardErr), acrylSettings.blockchainSettings.functionalitySettings, acrylSettings.dbSettings)
