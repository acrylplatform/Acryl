package com.acrylplatform.lang.compiler

import cats.kernel.Monoid
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.common.utils.EitherExt2
import com.acrylplatform.lang.Common
import com.acrylplatform.lang.Common.{NoShrink, produce}
...
import com.acrylplatform.lang.v1.compiler.{CompilerContext, Terms}
import com.acrylplatform.lang.v1.evaluator.FunctionIds
...
import com.acrylplatform.lang.v1.testing.ScriptGen
import com.acrylplatform.lang.v1.{ContractLimits, compiler}
...
class ContractCompilerTest extends PropSpec with PropertyChecks with Matchers with ScriptGen with NoShrink {
  ...
  property("hodlContract") {
    val ctx = Monoid
      .combineAll(
        Seq(
          PureContext.build(com.acrylplatform.lang.Global, V3),
          CryptoContext.build(com.acrylplatform.lang.Global, V3),
          AcrylContext.build(
            DirectiveSet(V3, Account, DAppType).explicitGet(),
            Common.emptyBlockchainEnvironment()
          )
    ...
    val expr = {
      val script =
        """
          ...
          |   else TransferSet([ScriptTransfer(i.caller, acrylBalance(this), base58'somestr')])
          | }
          |
          | @Verifier(t)
          | func verify() = {
  ...
  property("matching case with non-existing type should produce error message with suitable types") {
    ...
    val verifierTypes = AcrylContext.verifierInput.typeList.map(_.name)
