package com.acrylplatform.lang.v1
...
import com.acrylplatform.lang.contract.{ContractSerDe, DApp}
import com.acrylplatform.lang.directives.values.{Expression, StdLibVersion, DApp => DAppType}
import com.acrylplatform.lang.script.{ContractScript, Script}
import com.acrylplatform.lang.utils
import com.acrylplatform.lang.v1.compiler.Terms.EXPR
import com.acrylplatform.lang.v1.compiler.{CompilerContext, ContractCompiler, ExpressionCompiler, Terms}
...
trait BaseGlobal {
  ...
  def compileExpression(input: String,
    ...
    for {
      ...
      illegalBlockVersionUsage = restrictToLetBlockOnly && com.acrylplatform.lang.v1.compiler.сontainsBlockV2(ex)
