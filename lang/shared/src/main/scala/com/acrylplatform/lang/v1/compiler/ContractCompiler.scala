package com.acrylplatform.lang.v1.compiler
import cats.Show
import cats.implicits._
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.lang.contract.DApp
import com.acrylplatform.lang.contract.DApp._
import com.acrylplatform.lang.v1.compiler.CompilationError.{AlreadyDefined, Generic, WrongArgumentType}
import com.acrylplatform.lang.v1.compiler.CompilerContext.vars
import com.acrylplatform.lang.v1.compiler.ExpressionCompiler._
import com.acrylplatform.lang.v1.compiler.Terms.DECLARATION
import com.acrylplatform.lang.v1.compiler.Types.{BOOLEAN, UNION}
import com.acrylplatform.lang.v1.evaluator.ctx.FunctionTypeSignature
import com.acrylplatform.lang.v1.evaluator.ctx.impl.acryl.{FieldNames, AcrylContext}
import com.acrylplatform.lang.v1.parser.Expressions.{FUNC, PART, Pos}
import com.acrylplatform.lang.v1.parser.{Expressions, Parser}
import com.acrylplatform.lang.v1.task.imports._
      ...
      case (List(c: CallableAnnotation), (func, tpe, _)) =>
        for {
          _ <- Either
            .cond(
              tpe match {
                case _ if tpe <= UNION(AcrylContext.writeSetType, AcrylContext.scriptTransferSetType, AcrylContext.scriptResultType) =>
                  true
                case _ => false
              },
              (),
