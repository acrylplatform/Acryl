package com.acrylplatform.lang.v1.evaluator.ctx.impl

import cats.Eval
import cats.data.EitherT
import cats.syntax.either._
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.lang.directives.values.{StdLibVersion, V3, _}
import com.acrylplatform.lang.v1.compiler.Terms.{CONST_BOOLEAN, CONST_BYTESTR, CONST_STRING, CaseObj}
import com.acrylplatform.lang.v1.compiler.Types.{BOOLEAN, BYTESTR, CASETYPEREF, FINAL, STRING, UNION}
import com.acrylplatform.lang.v1.compiler.{CompilerContext, Terms}
import com.acrylplatform.lang.v1.evaluator.FunctionIds._
import com.acrylplatform.lang.v1.evaluator.ctx.impl.crypto.RSA.DigestAlgorithm
import com.acrylplatform.lang.v1.evaluator.ctx.{BaseFunction, EvaluationContext, LazyVal, NativeFunction}
import com.acrylplatform.lang.v1.{BaseGlobal, CTX}
...
object CryptoContext {
  ...
  private def algFromCO(obj: Terms.CaseObj): Either[String, DigestAlgorithm] = {
    import com.acrylplatform.lang.v1.evaluator.ctx.impl.crypto.RSA._
    obj match {
