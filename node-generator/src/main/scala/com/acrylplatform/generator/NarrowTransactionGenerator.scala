...
import cats.Show
import com.acrylplatform.account.{AddressScheme, Alias, KeyPair}
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.common.utils.{Base58, EitherExt2}
import com.acrylplatform.generator.NarrowTransactionGenerator.{ScriptSettings, Settings}
...
import com.acrylplatform.state.DataEntry.{MaxValueSize, Type}
...
import com.acrylplatform.transaction.lease.{LeaseCancelTransaction, LeaseCancelTransactionV2, LeaseTransactionV2}
    ...
    object preconditions {
      ...
      val tradeAssetIssue = IssueTransactionV2
        .selfSigned(
          ...
          "Acryl DEX is the best exchange ever".getBytes("UTF-8"),
          100000000,
          2,
          reissuable = false,
          fee = 100400000L,
      ...
      case ((allTxsWithValid, validIssueTxs, reissuableIssueTxs, activeLeaseTransactions, aliases), i) =>
        ...
        val tx = typeGen.getRandom match {
          ...
          case ExchangeTransactionV1 =>
            ...
            val pair      = AssetPair(Acryl, IssuedAsset(preconditions.tradeAssetIssue.id()))
          ...
          case InvokeScriptTransaction =>
            ...
            val asset = randomFrom(Universe.IssuedAssets.filter(a => script.paymentAssets.contains(new String(a.name))))
              .fold(Acryl: Asset)(tx => IssuedAsset(tx.id()))
