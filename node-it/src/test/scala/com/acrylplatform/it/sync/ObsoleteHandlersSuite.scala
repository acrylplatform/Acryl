...
import com.acrylplatform.api.http.alias.CreateAliasV1Request
import com.acrylplatform.api.http.assets.{
  BurnV1Request,
  IssueV1Request,
  MassTransferRequest,
  ReissueV1Request,
...
import com.acrylplatform.api.http.leasing.{LeaseCancelV1Request, LeaseV1Request, SignedLeaseCancelV1Request, SignedLeaseV1Request}
import com.acrylplatform.it.api.SyncHttpApi._
import com.acrylplatform.it.api.Transaction
...
import com.acrylplatform.api.http.DataRequest
...
class ObsoleteHandlersSuite extends BaseTransactionSuite {
  ...
  test("assets masstransfer") {
    ...
    val transfers                               = List(Transfer(secondAddress, 1.acryl), Transfer(thirdAddress, 2.acryl))
