...
import com.acrylplatform.consensus.FairPoSCalculator
...
import com.acrylplatform.it.api.AsyncNetworkApi.NodeAsyncNetworkApi
import com.acrylplatform.it.api.SyncHttpApi._
import com.acrylplatform.it.transactions.NodesFromDocker
import com.acrylplatform.it.{NodeConfigs, WaitForHeight2}
import com.acrylplatform.network.RawBytes
...
class PoSSuite extends FunSuite with Matchers with NodesFromDocker with WaitForHeight2 with CancelAfterFailure {
  ...
  override protected def nodeConfigs: Seq[Config] =
    NodeConfigs.newBuilder
      ...
      .withDefault(3)
      .withSpecial(_.raw("acryl.miner.enable = yes"))
      .buildNonConflicting()
