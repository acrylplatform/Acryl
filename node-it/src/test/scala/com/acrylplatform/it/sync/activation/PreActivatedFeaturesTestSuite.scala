...
import com.acrylplatform.features.api.NodeFeatureStatus
import com.acrylplatform.features.{BlockchainFeatureStatus, BlockchainFeatures}
import com.acrylplatform.it.{Docker, ReportingTestName}
...
object PreActivatedFeaturesTestSuite {
  ...
  private val supportedConfig    = ConfigFactory.parseString(s"""acryl {
                                                             ...
                                                             |  miner.quorum = 1
                                                             |}""".stripMargin)
  private val preactivatedConfig = ConfigFactory.parseString(s"""acryl {
                                                                |  blockchain.custom.functionality {
                                                                |  feature-check-blocks-period = $votingInterval
                                                                |  pre-activated-features {
                                                                |        1: 0
