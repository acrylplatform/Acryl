package com.acrylplatform.it.sync.utils

import com.acrylplatform.account.{Address, AddressScheme, Alias, PublicKey}
...
import com.acrylplatform.state.{BinaryDataEntry, BooleanDataEntry, IntegerDataEntry}
...
import com.acrylplatform.transaction.lease.{LeaseCancelTransactionV1, LeaseCancelTransactionV2, LeaseTransactionV1, LeaseTransactionV2}
...
import com.acrylplatform.transaction.transfer.{MassTransferTransaction, TransferTransactionV1, TransferTransactionV2}
import com.acrylplatform.transaction.{CreateAliasTransactionV1, CreateAliasTransactionV2, DataTransaction, Proofs}
...
class TransactionSerializeSuite extends BaseTransactionSuite with TableDrivenPropertyChecks {
  ...
  private val buyV2 = OrderV2(
    ...
    AssetPair.createAssetPair("ACRYL", "9ZDWzK53XT5bixkmMwTJi2YzgxCqn5dUajXFcT2HcFDy").get,
    OrderType.BUY,
    2,
    60.acryl,
    tsOrderFrom,
  ...
  private val transfers = MassTransferTransaction
    .parseTransfersList(List(Transfer(firstAddress, 1.acryl), Transfer(secondAddress, 2.acryl)))
    .right
    .get
