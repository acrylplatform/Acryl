...
import com.acrylplatform.protobuf.block.PBBlocks
...
object Exporter extends ScorexLogging {
  private[acrylplatform] object Formats {
    val Binary   = "BINARY"
  ...
  private[this] final case class ExporterOptions(configFileName: File = new File("acryl-testnet.conf"),
  ...
  private[this] lazy val commandParser = {
    ...
    OParser.sequence(
      programName("acryl export"),
      head("Acryl Blockchain Exporter", Version.VersionString),
      opt[File]('c', "config")
