...
import com.acrylplatform.Exporter.Formats
...
object Importer extends ScorexLogging {
  ...
  private[this] final case class ImportOptions(configFile: File = new File("acryl-testnet.conf"),
  ...
  private[this] lazy val commandParser = {
    ...
    OParser.sequence(
      programName("acryl import"),
      head("Acryl Blockchain Importer", Version.VersionString),
      opt[File]('c', "config")
