...
import com.acrylplatform.api.common.{CommonAccountApi, CommonAssetsApi}
import com.acrylplatform.api.http.ApiError._
import com.acrylplatform.api.http._
import com.acrylplatform.api.http.assets.AssetsApiRoute.DistributionParams
...
import com.acrylplatform.transaction.assets.exchange.OrderJson._
import com.acrylplatform.transaction.smart.script.ScriptCompiler
import com.acrylplatform.transaction.{AssetIdStringLength, TransactionFactory}
import com.acrylplatform.utils.{Time, _}
      ...
      val distributionTask = assetEi match {
        ...
        case Right(asset) =>
          Task
            ...
            .map(dst => Json.toJson(dst)(com.acrylplatform.state.dstWrites): ToResponseMarshallable)
      }
