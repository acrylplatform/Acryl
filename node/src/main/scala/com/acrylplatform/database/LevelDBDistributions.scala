...
import com.acrylplatform.state.{AddressId, AssetDistribution, AssetDistributionPage, Portfolio}
...
private[database] final class LevelDBDistributions(ldb: LevelDBWriter) extends Distributions {
  ...
  import com.acrylplatform.features.FeatureProvider.FeatureProviderExt
  import ldb._
