...
import com.acrylplatform.mining.Miner.MaxTransactionsPerMicroblock
import com.acrylplatform.network.message.Message._
import com.acrylplatform.network.message._
...
object TransactionSpec extends MessageSpec[Transaction] {
  ...
  // Modeled after Data Transaction https://acrylplatform.atlassian.net/wiki/spaces/MAIN/pages/119734321/Data+Transaction
