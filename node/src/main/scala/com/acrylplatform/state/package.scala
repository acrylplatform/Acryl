...
import com.acrylplatform.consensus.GeneratingBalanceProvider
import com.acrylplatform.lang.ValidationError
import com.acrylplatform.transaction.Asset.IssuedAsset
import com.acrylplatform.transaction.TxValidationError.{AliasDoesNotExist, GenericError}
...
import com.acrylplatform.utils.{CloseableIterator, Paged}
...
package object state {
  ...
  implicit class BlockchainExt(private val blockchain: Blockchain) extends AnyVal {
    ...
    def acrylPortfolio(address: Address): Portfolio = Portfolio(
