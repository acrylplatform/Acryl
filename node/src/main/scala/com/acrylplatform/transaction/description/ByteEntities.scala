package com.acrylplatform.transaction.description

import cats.{Functor, Semigroupal}
import com.google.common.primitives.{Ints, Longs, Shorts}
import com.acrylplatform.account.{Address, AddressOrAlias, Alias, PublicKey}
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.common.utils.EitherExt2
import com.acrylplatform.crypto.{KeyLength, SignatureLength}
...
import com.acrylplatform.lang.v1.{ContractLimits, Serde}
...
case class PaymentBytes(index: Int, name: String) extends ByteEntity[Payment] {
  ...
  def deserialize(buf: Array[Byte], offset: Int): Try[(Payment, Int)] = {
    Try {
      ...
      val asset             = maybeAssetId.fold[Asset](Acryl)(IssuedAsset)
