...
import com.acrylplatform.account.{Address, AddressOrAlias, Alias}
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.lang.v1.compiler.Terms.EVALUATED
import com.acrylplatform.lang.v1.traits.domain.Tx.{Header, Proven}
import com.acrylplatform.lang.v1.traits.domain._
...
import com.acrylplatform.transaction.assets.exchange.{AssetPair, ExchangeTransaction, Order}
    ...
    tx match {
      ...
      case ms: MassTransferTransaction =>
        Tx.MassTransfer(
          ...
          transfers = ms.transfers.map(r => com.acrylplatform.lang.v1.traits.domain.Tx.TransferItem(r.address, r.amount)).toIndexedSeq,
