...
import com.acrylplatform.account.{Address, AddressOrAlias}
...
// [WAIT] import com.acrylplatform.lang.{Global, StdLibVersion}
import com.acrylplatform.lang.contract.DApp
import com.acrylplatform.lang.contract.DApp.{VerifierAnnotation, VerifierFunction}
// [WAIT] import com.acrylplatform.lang.v1.compiler.Decompiler
import com.acrylplatform.lang.v1.compiler.Terms._
// [WAIT] import com.acrylplatform.lang.v1.evaluator.ctx.impl.{CryptoContext, PureContext}
...
import com.acrylplatform.{NoShrink, TestTime, TestWallet, crypto}
...
class AddressRouteSpec
  ...
  routePath(s"/scriptInfo/${allAddresses(1)}") in {
    ...
    Get(routePath(s"/scriptInfo/${allAddresses(3)}")) ~> route ~> check {
      ...
      // [WAIT]                                           Decompiler(
      //      testContract,
      //      Monoid.combineAll(Seq(PureContext.build(com.acrylplatform.lang.directives.values.StdLibVersion.V3), CryptoContext.build(Global))).decompilerContext)
