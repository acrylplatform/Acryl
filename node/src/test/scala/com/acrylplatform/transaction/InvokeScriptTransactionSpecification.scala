...
import com.acrylplatform.api.http.{InvokeScriptRequest, SignedInvokeScriptRequest}
import com.acrylplatform.common.state.ByteStr
import com.acrylplatform.common.utils.{Base64, _}
import com.acrylplatform.lang.v1.compiler.Terms
import com.acrylplatform.lang.v1.compiler.Terms.{ARR, CONST_LONG, CaseObj}
import com.acrylplatform.lang.v1.compiler.Types.CASETYPEREF
...
import com.acrylplatform.transaction.TxValidationError.NonPositiveAmount
...
class InvokeScriptTransactionSpecification extends PropSpec with PropertyChecks with Matchers with TransactionGen {
  ...
  property("Signed InvokeScriptTransactionRequest parser") {
    ...
    val req = SignedInvokeScriptRequest(
      ...
      payment = Some(Seq(Payment(1, Acryl))),
      dApp = "3Fb641A9hWy63K18KsBJwns64McmdEATgJd",
      timestamp = 11,
  ...
  property("can't have zero amount") {
    ...
    val req = SignedInvokeScriptRequest(
      ...
      payment = Some(Seq(Payment(0, Acryl))),
      dApp = "3Fb641A9hWy63K18KsBJwns64McmdEATgJd",
      timestamp = 11,
      proofs = List("CC1jQ4qkuVfMvB2Kpg2Go6QKXJxUFC8UUswUxBsxwisrR8N5s3Yc8zA6dhjTwfWKfdouSTAnRXCxTXb3T6pJq3T")
    )
    req.toTx shouldBe Left(NonPositiveAmount(0, "Acryl"))
    AddressScheme.current = DefaultAddressScheme
  }
  ...
  property("can't have negative amount") {
    ...
    req.toTx shouldBe Left(NonPositiveAmount(-1, "Acryl"))
    AddressScheme.current = DefaultAddressScheme
  }
}
